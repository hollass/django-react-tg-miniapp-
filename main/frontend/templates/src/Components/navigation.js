                            ...
                            <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path d="M9 16C9.85038 16.6303 10.8846 17 12 17C13.1154 17 14.1496 16.6303 15 16"
                                          stroke="var(--tg-theme-text-color)" strokeWidth="1.5" strokeLinecap="round"></path>
                                    <path
                            ...
                            <svg width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path
                                        ...
                                        stroke="var(--tg-theme-text-color)" stroke-width="1.5" stroke-linecap="round"></path>
                                    <path
                                        ...
                                        fill="var(--tg-theme-text-color)"></path>
                                </g>
                            </svg>
                            <p>Записаться</p></div>
                    </Button>
                            ...
                            <svg className={'icon'} width="30px" height="30px" viewBox="0 0 24 24" fill="none"
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path
                                        ...
                                        stroke="var(--tg-theme-text-color)" strokeWidth="1.5" strokeLinecap="round"></path>
                                    <path d="M9 17.5H15" stroke="var(--tg-theme-text-color)" strokeWidth="1.5"
                                          strokeLinecap="round"></path>
                                    <path
                                        d="M8 3.5C8 2.67157 8.67157 2 9.5 2H14.5C15.3284 2 16 2.67157 16 3.5V4.5C16 5.32843 15.3284 6 14.5 6H9.5C8.67157 6 8 5.32843 8 4.5V3.5Z"
                                        stroke="var(--tg-theme-text-color)" strokeWidth="1.5"></path>
                                    <path d="M8 14H9M16 14H12" stroke="#1C274C" strokeWidth="1.5"
                                          strokeLinecap="round"></path>
                                    <path d="M17 10.5H15M12 10.5H7" stroke="var(--tg-theme-text-color)" strokeWidth="1.5"
                                          strokeLinecap="round"></path>
                                </g>
                            </svg>
                            <p>Записи</p>
                            ...
                            <g id="SVGRepo_bgCarrier" strokeWidth="0"></g>
                                ...
                                <g id="SVGRepo_iconCarrier">
                                    <path
                                        ...
                                        stroke="var(--tg-theme-text-color)" strokeWidth="1.5" strokeLinecap="round"></path>
                                    <circle cx="12" cy="6" r="4" stroke="var(--tg-theme-text-color)" strokeWidth="1.5"></circle>
                                </g>
                            </svg>
                            <p>Профиль</p>
                        </div>
