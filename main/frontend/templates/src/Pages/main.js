...
import {request, TG} from "../Components/api";
            ...
            <div className={'home-block-search'}>
                <InputGroup className="mb-3">
                    ...
                    <Button variant="outline-secondary" id="button-addon2">
                        <svg width="30px" height="30px" viewBox="0 -0.5 25 25" fill="var(--tg-theme-text-color)"
                            ...
                            <g id="SVGRepo_iconCarrier">
                                <path fillRule="evenodd" clipRule="evenodd"
                                      ...
                                      stroke="var(--tg-theme-text-color)" strokeWidth="1.5" strokeLinecap="round"
